...
#define SEISMO_Y_END 150     // End above the "Latest Activity" section (moved up)
...
void drawSeismographScreen() {
  ...
  // Draw static box for Latest Activity section (now taller - 85 pixels high)
  tft.drawRect(0, 155, 160, 85, TFT_DARKGREY);
...
void updateLatestActivity() {
  // Clear the latest activity area (now taller)
  tft.fillRect(1, 156, 158, 83, TFT_BLACK);
  ...
  if (lastQuake.hasData) {
    ...
    // Show magnitude and location
    tft.setCursor(5, 200);
    tft.print("M");
    tft.println(lastQuake.magnitude, 1);
    
    tft.setTextSize(1);  // Smaller text for location
    tft.setCursor(5, 222);
...
void animateSeismograph() {
  ...
  int maxAmplitude = 60; // Reduced amplitude for smaller vertical space
...
void drawDetailedNZMap() {
  // Draw North Island outline
  // Upper North Island
  tft.drawLine(mapLon(174.0), mapLat(-34.4), mapLon(174.5), mapLat(-35.0), TFT_WHITE);
  tft.drawLine(mapLon(174.5), mapLat(-35.0), mapLon(174.8), mapLat(-36.0), TFT_WHITE);
  tft.drawLine(mapLon(174.8), mapLat(-36.0), mapLon(175.0), mapLat(-37.0), TFT_WHITE);
  
  // East Cape
  tft.drawLine(mapLon(175.0), mapLat(-37.0), mapLon(178.5), mapLat(-37.8), TFT_WHITE);
  
  // Hawke's Bay to Wellington
  tft.drawLine(mapLon(178.5), mapLat(-37.8), mapLon(177.0), mapLat(-39.3), TFT_WHITE);
  tft.drawLine(mapLon(177.0), mapLat(-39.3), mapLon(175.5), mapLat(-41.3), TFT_WHITE);
  
  // West coast North Island
  tft.drawLine(mapLon(174.0), mapLat(-34.4), mapLon(174.0), mapLat(-39.0), TFT_WHITE);
  tft.drawLine(mapLon(174.0), mapLat(-39.0), mapLon(174.8), mapLat(-41.0), TFT_WHITE);
  
  // Cook Strait
  tft.drawLine(mapLon(174.8), mapLat(-41.0), mapLon(174.0), mapLat(-41.3), TFT_WHITE);
  
  // Draw South Island outline
  // Top of South Island
  tft.drawLine(mapLon(173.0), mapLat(-40.8), mapLon(173.5), mapLat(-41.0), TFT_WHITE);
  tft.drawLine(mapLon(173.5), mapLat(-41.0), mapLon(174.0), mapLat(-41.3), TFT_WHITE);
  
  // East coast
  tft.drawLine(mapLon(174.0), mapLat(-41.3), mapLon(174.3), mapLat(-42.5), TFT_WHITE);
  tft.drawLine(mapLon(174.3), mapLat(-42.5), mapLon(171.5), mapLat(-43.6), TFT_WHITE);
  tft.drawLine(mapLon(171.5), mapLat(-43.6), mapLon(170.0), mapLat(-45.0), TFT_WHITE);
  tft.drawLine(mapLon(170.0), mapLat(-45.0), mapLon(169.0), mapLat(-46.5), TFT_WHITE);
  
  // Bottom
  tft.drawLine(mapLon(169.0), mapLat(-46.5), mapLon(168.0), mapLat(-46.6), TFT_WHITE);
  
  // West coast
  tft.drawLine(mapLon(168.0), mapLat(-46.6), mapLon(167.0), mapLat(-45.5), TFT_WHITE);
  tft.drawLine(mapLon(167.0), mapLat(-45.5), mapLon(166.5), mapLat(-43.5), TFT_WHITE);
  tft.drawLine(mapLon(166.5), mapLat(-43.5), mapLon(168.0), mapLat(-42.0), TFT_WHITE);
  tft.drawLine(mapLon(168.0), mapLat(-42.0), mapLon(169.0), mapLat(-41.5), TFT_WHITE);
  tft.drawLine(mapLon(169.0), mapLat(-41.5), mapLon(173.0), mapLat(-40.8), TFT_WHITE);
