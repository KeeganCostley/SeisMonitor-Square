...
void drawJapanMap() {
  ...
  // HOKKAIDO - Detailed (18 points)
  const float hokkaido[][2] = {
    {45.5, 141.4}, {45.3, 142.2}, {45.0, 143.0}, {44.5, 143.8},
    {44.0, 144.5}, {43.3, 145.2}, {42.6, 145.4}, {42.0, 144.8},
    {41.6, 144.0}, {41.4, 143.0}, {41.4, 142.0}, {41.5, 141.2},
    {41.8, 140.5}, {42.3, 140.1}, {43.0, 140.2}, {43.8, 140.6},
    {44.7, 141.0}, {45.5, 141.4}
  };
  
  // HONSHU - Detailed but memory-efficient (60 points)
  const float honshu[][2] = {
    // AOMORI (north tip)
    {41.5, 140.7}, {41.3, 141.0}, {41.0, 141.3},
    // TOHOKU (northeast coast)
    {40.5, 141.5}, {40.0, 141.6}, {39.5, 141.7}, {39.0, 141.7},
    {38.5, 141.5}, {38.0, 141.2}, {37.5, 140.8}, {37.0, 140.3},
    // KANTO (Tokyo area)
    {36.5, 139.9}, {36.2, 139.7}, {36.0, 139.8}, {35.7, 140.1},
    {35.5, 140.5}, {35.4, 140.7}, // Boso Peninsula
    {35.2, 140.5}, {35.0, 140.2}, {34.8, 139.8},
    // IZU
    {34.6, 139.3}, {34.4, 138.8}, {34.3, 138.4},
    // TOKAI
    {34.3, 138.0}, {34.2, 137.5}, {34.1, 137.0},
    // KII Peninsula
    {34.0, 136.5}, {33.8, 136.0}, {33.7, 135.5}, {33.8, 135.0},
    // OSAKA
    {34.0, 134.6}, {34.1, 134.2},
    // SETO
    {34.0, 133.8}, {34.0, 133.4}, {33.9, 133.0}, {33.8, 132.6},
    // SOUTHWEST
    {33.7, 132.2}, {33.6, 131.8}, {33.5, 131.4},
    // WEST COAST
    {33.7, 131.6}, {34.0, 132.0}, {34.5, 132.5}, {35.0, 133.0},
    {35.5, 133.5}, {36.0, 134.0}, {36.5, 134.5}, {37.0, 135.0},
    {37.5, 135.5}, {38.0, 136.2}, {38.5, 137.0}, {39.0, 137.8},
    {39.5, 138.6}, {40.0, 139.5}, {40.5, 140.3}, {41.0, 140.6},
    {41.5, 140.7}
  };
  
  // KYUSHU (15 points)
  const float kyushu[][2] = {
    {34.0, 131.0}, {33.7, 131.4}, {33.4, 131.6}, {33.0, 131.6},
    {32.6, 131.2}, {32.3, 130.7}, {32.2, 130.2}, {32.4, 129.9},
    {32.8, 129.8}, {33.2, 129.9}, {33.6, 130.3}, {33.9, 130.7},
    {34.0, 131.0}
  };
  
  // SHIKOKU (15 points)
  const float shikoku[][2] = {
    {34.2, 134.5}, {34.0, 134.8}, {33.7, 134.7}, {33.4, 134.4},
    {33.2, 134.0}, {33.1, 133.6}, {33.1, 133.2}, {33.3, 132.8},
    {33.6, 132.7}, {34.0, 132.8}, {34.3, 133.2}, {34.4, 133.7},
    {34.2, 134.5}
  };
...
void drawChinaMap() {
  ...
  // CHINA - Detailed but memory-efficient (80 points)
  const float china[][2] = {
    // NORTHEAST
    {53.5, 127.0}, {52.5, 129.0}, {51.5, 131.0}, {50.0, 133.5},
    {48.5, 134.0}, {47.0, 133.0}, {45.0, 131.0}, {43.0, 128.0},
    {41.5, 124.0}, {40.5, 122.0},
    // BOHAI SEA
    {40.0, 121.0}, {39.0, 120.3}, {38.0, 120.0}, {37.2, 120.5},
    // SHANDONG
    {37.0, 121.5}, {37.0, 122.2}, {36.5, 121.5}, {35.5, 120.5},
    // EAST COAST
    {34.0, 120.0}, {32.5, 121.2}, {31.2, 122.0}, {30.0, 121.8},
    {28.5, 121.0}, {27.0, 120.5}, {25.5, 119.5}, {24.0, 118.0},
    // SOUTH
    {23.0, 117.0}, {22.0, 115.5}, {21.6, 113.5}, {21.2, 111.0},
    {21.0, 109.0},
    // SOUTHWEST
    {21.5, 107.5}, {22.5, 106.0}, {23.5, 104.5}, {25.0, 102.5},
    {26.5, 101.0}, {28.0, 99.5}, {29.0, 98.0},
    // TIBET (west curve)
    {29.5, 96.0}, {30.0, 92.0}, {30.5, 88.0}, {31.5, 83.0},
    {32.5, 80.0}, {34.0, 77.0}, {35.0, 76.0},
    // XINJIANG (northwest)
    {37.0, 75.5}, {39.0, 75.2}, {41.0, 76.0}, {43.0, 78.0},
    {45.0, 83.0}, {46.5, 88.0}, {48.0, 93.0}, {49.0, 98.0},
    {49.5, 102.0},
    // NORTH (Mongolia border)
    {50.0, 106.0}, {50.5, 110.0}, {51.0, 114.0}, {51.5, 118.0},
    {52.0, 121.0}, {52.7, 124.0}, {53.5, 127.0}
  };
...
void drawGlobalMap() {
  ...
  // DETAILED CONTINENTS (memory-efficient)
  
  // NORTH AMERICA (12 points)
  const int northAmerica[][2] = {
    {centerX - 42, centerY - 52}, {centerX - 35, centerY - 45},
    {centerX - 30, centerY - 38}, {centerX - 27, centerY - 30},
    {centerX - 29, centerY - 20}, {centerX - 32, centerY - 10},
    {centerX - 32, centerY - 2}, {centerX - 29, centerY + 5},
  ...
  const int southAmerica[][2] = {
    {centerX - 26, centerY + 12}, {centerX - 24, centerY + 20},
    {centerX - 27, centerY + 30}, {centerX - 27, centerY + 40},
    {centerX - 24, centerY + 48}, {centerX - 21, centerY + 52}
  };
  for (int i = 0; i < 5; i++) {
  ...
  // EUROPE (6 points)
  const int europe[][2] = {
    {centerX + 6, centerY - 46}, {centerX + 10, centerY - 38},
    {centerX + 12, centerY - 32}, {centerX + 10, centerY - 26},
    {centerX + 7, centerY - 22}
  };
  for (int i = 0; i < 4; i++) {
  ...
  // AFRICA (10 points)
  const int africa[][2] = {
    {centerX + 7, centerY - 22}, {centerX + 12, centerY - 14},
    {centerX + 17, centerY - 4}, {centerX + 18, centerY + 6},
    {centerX + 16, centerY + 16}, {centerX + 13, centerY + 26},
    {centerX + 9, centerY + 35}
  };
  for (int i = 0; i < 6; i++) {
  ...
  // ASIA (10 points)
  const int asia[][2] = {
    {centerX + 16, centerY - 36}, {centerX + 26, centerY - 40},
    {centerX + 36, centerY - 38}, {centerX + 42, centerY - 28},
    {centerX + 42, centerY - 16}, {centerX + 38, centerY - 4},
    {centerX + 33, centerY + 2}
  };
  for (int i = 0; i < 6; i++) {
  ...
  const int australia[][2] = {
    {centerX + 36, centerY + 22}, {centerX + 41, centerY + 30},
    {centerX + 40, centerY + 38}, {centerX + 35, centerY + 38},
    {centerX + 31, centerY + 32}, {centerX + 32, centerY + 24},
    {centerX + 36, centerY + 22}
  };
  for (int i = 0; i < 6; i++) {
