...
void drawJapanMap() {
  // HOKKAIDO - Simple recognizable northern island
  const float hokkaido[][2] = {
    // Northeast
    {45.50, 142.00}, {45.20, 144.00}, {44.50, 145.00},
    {43.50, 145.50}, {42.50, 145.00}, {41.80, 143.50},
    // South
    {41.50, 142.00}, {41.40, 140.50}, {41.80, 140.00},
    // West  
    {43.00, 140.00}, {44.00, 140.50}, {45.00, 141.50}, {45.50, 142.00}
  };
  
  // HONSHU - Main island emphasizing KEY features
  const float honshu[][2] = {
    // NORTH END (Aomori)
    {41.50, 140.80},
    // DOWN EAST COAST
    {40.50, 141.00}, {39.50, 141.50}, {38.50, 141.00},
    {37.50, 140.00},  
    // TOKYO BAY (big eastward bulge)
    {36.50, 139.00}, {35.80, 139.50}, {35.50, 140.00}, {35.20, 140.50},
    // BACK WEST
    {35.00, 139.80}, {34.70, 139.00},
    // SOUTH COAST
    {34.50, 137.00}, {34.20, 135.00}, {34.00, 133.50},
    // SOUTHWEST TIP (Yamaguchi)
    {33.80, 132.00}, {33.50, 131.00},
    // UP WEST COAST (Sea of Japan side)
    {34.00, 131.50}, {35.00, 133.00}, {36.00, 134.00},
    {37.00, 135.50}, {38.00, 137.00}, {39.00, 139.00},
    {40.00, 139.80}, {41.00, 140.50}, {41.50, 140.80}
  };
  
  // KYUSHU - Southern island
  const float kyushu[][2] = {
    {34.00, 131.50}, {33.50, 132.00}, {33.00, 131.50},
    {32.50, 130.50}, {33.00, 130.00}, {33.80, 130.50}, {34.00, 131.50}
  };
  
  // SHIKOKU - Small island between Honshu and Kyushu
  const float shikoku[][2] = {
    {34.20, 134.50}, {33.80, 135.00}, {33.50, 134.00},
    {33.50, 133.00}, {34.00, 133.00}, {34.50, 133.50}, {34.20, 134.50}
  };
...
void drawTaiwanMap() {
  // Simple Taiwan - elongated north-south with east bulge (mountains)
  const float taiwan[][2] = {
    // North (Taipei)
    {25.30, 121.60},
    // Northeast (bulge for mountains)
    {25.00, 122.00}, {24.50, 121.90}, {24.00, 121.70},
    // East coast (mountain side - wider)
    {23.50, 121.50}, {23.00, 121.30}, {22.50, 121.00},
    // South tip (Kenting)
    {22.00, 120.80},
    // Southwest
    {22.00, 120.50}, {22.50, 120.30},
    // West coast (plains side - straighter)
    {23.00, 120.20}, {23.50, 120.15}, {24.00, 120.20},
    {24.50, 120.40}, {25.00, 120.80}, {25.20, 121.20},
    // Back to north
    {25.30, 121.60}
  };
