...
void drawJapanMap() {
  ...
  // Test first point mapping
  Serial.print("Test point (35.7, 140.5) maps to screen: ");
  int testX = mapLonToScreen(140.5);
  int testY = mapLatToScreen(35.7);
  Serial.print(testX);
  Serial.print(", ");
  Serial.println(testY);
  Serial.print("Map area: X=");
  Serial.print(MAP_X);
  Serial.print(" to ");
  Serial.print(MAP_X + MAP_WIDTH);
  Serial.print(", Y=");
  Serial.print(MAP_Y);
  Serial.print(" to ");
  Serial.println(MAP_Y + MAP_HEIGHT);
...
void drawChinaMap() {
  // CHINA - Recognizable mainland outline
  const float china[][2] = {
    // NORTHEAST (Heilongjiang)
    {53.5, 127.0}, {51.5, 130.5}, {49.0, 133.5},
    // EAST COAST (turn south)
    {46.0, 133.0}, {43.0, 130.0}, {41.0, 123.0},
    // BOHAI SEA (indent)
    {40.0, 121.0}, {39.0, 120.0}, {38.0, 120.5},
    // SHANDONG PENINSULA (eastward bulge)
    {37.0, 122.0}, {36.0, 120.5},
    // EAST COAST continued
    {34.0, 120.0}, {32.0, 121.5}, {30.0, 122.0},
    {28.0, 121.0}, {26.0, 120.0}, {24.0, 118.0},
    // SOUTH COAST
    {22.5, 115.0}, {21.5, 112.0}, {21.0, 109.0},
    // SOUTHWEST (Vietnam border)
    {22.0, 106.0}, {24.0, 103.0}, {26.0, 100.0},
    {28.0, 98.0},
    // WEST (Tibet, Himalayas - big westward curve)
    {30.0, 90.0}, {32.0, 82.0}, {35.0, 76.0},
    // NORTHWEST (Xinjiang)
    {40.0, 75.0}, {43.0, 80.0}, {46.0, 87.0},
    {48.0, 92.0}, {49.5, 97.0},
    // NORTH (Mongolia border)
    {50.5, 105.0}, {51.5, 115.0}, {52.5, 122.0}, {53.5, 127.0}
  };
