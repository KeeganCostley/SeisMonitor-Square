...
void drawJapanMap() {
  // HOKKAIDO - Very detailed northern island
  const float hokkaido[][2] = {
    // Northeast cape
    {45.52, 141.35}, {45.50, 141.65}, {45.45, 141.95}, {45.38, 142.25},
    {45.28, 142.55}, {45.15, 142.85}, {45.00, 143.15}, {44.82, 143.45},
    // East coast
    {44.62, 143.75}, {44.40, 144.05}, {44.15, 144.35}, {43.88, 144.65},
    {43.58, 144.95}, {43.25, 145.25}, {42.90, 145.50}, {42.55, 145.65},
    // Southeast
    {42.20, 145.70}, {41.88, 145.60}, {41.58, 145.40}, {41.30, 145.10},
    {41.08, 144.70}, {40.90, 144.25}, {40.80, 143.75}, {40.75, 143.20},
    // South coast
    {40.75, 142.65}, {40.80, 142.10}, {40.90, 141.55}, {41.05, 141.05},
    {41.25, 140.60}, {41.50, 140.20}, {41.80, 139.90}, {42.15, 139.70},
    // West coast
    {42.52, 139.60}, {42.90, 139.65}, {43.28, 139.80}, {43.65, 140.05},
    {44.00, 140.35}, {44.32, 140.70}, {44.62, 141.05}, {44.88, 141.40},
    {45.10, 141.75}, {45.28, 142.10}, {45.40, 142.45}, {45.52, 141.35}
  };
  
  // HONSHU - Main island, ultra-detailed
  const float honshu[][2] = {
    // Northern tip (connects to Hokkaido area)
    {41.52, 140.90}, {41.35, 140.65}, {41.15, 140.40}, {40.92, 140.20},
    {40.68, 140.05}, {40.42, 139.92}, {40.15, 139.82}, {39.88, 139.75},
    // Northeast coast (detailed)
    {39.60, 139.70}, {39.32, 139.68}, {39.05, 139.68}, {38.78, 139.65},
    {38.52, 139.60}, {38.25, 139.52}, {37.98, 139.42}, {37.72, 139.28},
    // North-central coast
    {37.45, 139.10}, {37.20, 138.88}, {36.95, 138.62}, {36.70, 138.32},
    {36.48, 138.00}, {36.28, 137.65}, {36.10, 137.28}, {35.95, 136.88},
    // Central west coast (Fukui/Ishikawa area)
    {35.82, 136.45}, {35.72, 136.02}, {35.65, 135.60}, {35.62, 135.18},
    // Kansai region (curves east)
    {35.62, 135.75}, {35.65, 136.20}, {35.72, 136.65}, {35.82, 137.08},
    {35.95, 137.48}, {36.10, 137.85}, {36.28, 138.18},
    // Tokyo Bay area (big eastward bump)
    {36.48, 138.50}, {36.50, 138.90}, {36.45, 139.28}, {36.35, 139.62},
    {36.20, 139.92}, {36.00, 140.18}, {35.78, 140.38}, {35.52, 140.52},
    {35.25, 140.58}, {35.00, 140.55}, {34.78, 140.42}, {34.58, 140.20},
    // Southeast coast (Chiba/Izu Peninsula)
    {34.42, 139.92}, {34.28, 139.60}, {34.18, 139.25}, {34.12, 138.88},
    {34.08, 138.50}, {34.08, 138.10}, {34.12, 137.68}, {34.18, 137.25},
    // South coast (Wakayama/Shikoku strait area)
    {34.25, 136.82}, {34.32, 136.38}, {34.40, 135.95}, {34.48, 135.52},
    {34.55, 135.10}, {34.60, 134.68}, {34.62, 134.25}, {34.62, 133.82},
    // Southwest tip (Yamaguchi area)
    {34.58, 133.40}, {34.50, 133.00}, {34.38, 132.62}, {34.22, 132.28},
    {34.02, 132.00}, {33.80, 131.75}, {33.55, 131.55}, {33.30, 131.42},
    // Bottom of Honshu
    {33.05, 131.35}, {32.82, 131.35}, {32.62, 131.42}, {32.45, 131.55},
    {32.32, 131.75}, {32.25, 132.00}, {32.25, 132.28}, {32.32, 132.58},
    // Southwest coast (back up)
    {32.45, 132.88}, {32.65, 133.15}, {32.88, 133.40}, {33.15, 133.62},
    {33.45, 133.82}, {33.75, 134.00}, {34.05, 134.15}, {34.35, 134.28},
    // West coast (Sanin region)
    {34.65, 134.38}, {34.95, 134.45}, {35.25, 134.50}, {35.55, 134.52},
    {35.85, 134.50}, {36.15, 134.45}, {36.45, 134.35}, {36.75, 134.22},
    {37.05, 134.05}, {37.35, 133.85}, {37.65, 133.62}, {37.95, 133.38},
    // Northwest coast
    {38.25, 133.12}, {38.55, 132.88}, {38.85, 132.68}, {39.15, 132.52},
    {39.45, 132.42}, {39.75, 132.38}, {40.05, 132.42}, {40.35, 132.55},
    {40.65, 132.75}, {40.95, 133.02}, {41.20, 133.35}, {41.40, 133.72},
    // Back to northern tip
    {41.55, 134.12}, {41.65, 134.55}, {41.70, 135.00}, {41.68, 135.45},
    {41.60, 135.88}, {41.45, 136.28}, {41.25, 136.65}, {41.00, 136.98},
    {40.72, 137.28}, {40.42, 137.55}, {40.10, 137.78}, {39.78, 137.98},
    {39.45, 138.15}, {39.12, 138.28}, {38.78, 138.38}, {38.45, 138.45},
    {38.12, 138.50}, {37.78, 138.52}, {37.45, 138.52}, {37.12, 138.48},
    {36.80, 138.42}, {36.48, 138.32}, {36.18, 138.18}, {35.90, 138.02},
    {35.65, 137.82}, {35.42, 137.60}, {35.22, 137.35}, {35.05, 137.08},
    {34.92, 136.78}, {34.82, 136.48}, {34.75, 136.15}, {34.72, 135.82},
    {34.72, 135.48}, {34.75, 135.15}, {34.82, 134.82}, {34.92, 134.50},
    {35.05, 134.20}, {35.22, 133.92}, {35.42, 133.68}, {35.65, 133.48},
    {35.90, 133.32}, {36.18, 133.22}, {36.48, 133.18}, {36.80, 133.20},
    {37.12, 133.28}, {37.45, 133.42}, {37.78, 133.62}, {38.12, 133.88},
    {38.45, 134.18}, {38.78, 134.52}, {39.12, 134.90}, {39.45, 135.30},
    {39.78, 135.72}, {40.10, 136.15}, {40.42, 136.60}, {40.72, 137.05},
    {41.00, 137.50}, {41.25, 137.95}, {41.45, 138.38}, {41.60, 138.80},
    {41.70, 139.20}, {41.75, 139.58}, {41.75, 139.95}, {41.70, 140.28},
    {41.60, 140.60}, {41.52, 140.90}
  };
  
  // KYUSHU - Southern island
  const float kyushu[][2] = {
    {33.90, 131.20}, {33.82, 131.45}, {33.70, 131.68}, {33.55, 131.88},
    {33.35, 132.02}, {33.12, 132.10}, {32.88, 132.12}, {32.65, 132.05},
    {32.45, 131.90}, {32.28, 131.68}, {32.15, 131.42}, {32.08, 131.12},
    {32.05, 130.82}, {32.08, 130.52}, {32.18, 130.25}, {32.35, 130.05},
    {32.58, 129.92}, {32.85, 129.88}, {33.15, 129.92}, {33.45, 130.05},
    {33.72, 130.25}, {33.95, 130.50}, {34.10, 130.78}, {34.18, 131.05},
    {34.18, 131.32}, {34.10, 131.58}, {33.95, 131.80}, {33.90, 131.20}
  };
  
  // SHIKOKU - Fourth main island
  const float shikoku[][2] = {
    {34.15, 134.60}, {34.05, 134.80}, {33.90, 134.92}, {33.70, 134.98},
    {33.48, 134.95}, {33.28, 134.82}, {33.12, 134.62}, {33.02, 134.38},
    {33.00, 134.10}, {33.05, 133.82}, {33.18, 133.55}, {33.38, 133.32},
    {33.62, 133.15}, {33.88, 133.05}, {34.15, 133.02}, {34.42, 133.08},
    {34.65, 133.22}, {34.85, 133.42}, {34.98, 133.68}, {35.05, 133.95},
    {35.05, 134.22}, {34.95, 134.48}, {34.78, 134.70}, {34.55, 134.88},
    {34.30, 134.98}, {34.15, 134.60}
  };
...
void drawTaiwanMap() {
  // High-detail Taiwan coastline
  const float taiwan[][2] = {
    // North tip
    {25.30, 121.57}, {25.28, 121.68}, {25.25, 121.78}, {25.20, 121.88},
    {25.12, 121.95}, {25.02, 121.98},
    // Northeast coast
    {24.92, 121.96}, {24.82, 121.92}, {24.72, 121.85}, {24.62, 121.78},
    {24.52, 121.70}, {24.42, 121.62}, {24.32, 121.55},
    // East coast (detailed)
    {24.22, 121.50}, {24.12, 121.46}, {24.02, 121.43}, {23.92, 121.40},
    {23.82, 121.38}, {23.72, 121.36}, {23.62, 121.34}, {23.52, 121.32},
    {23.42, 121.30}, {23.32, 121.27}, {23.22, 121.24}, {23.12, 121.20},
    // Southeast
    {23.02, 121.15}, {22.92, 121.08}, {22.82, 121.00}, {22.72, 120.92},
    {22.62, 120.84}, {22.52, 120.76}, {22.42, 120.70}, {22.32, 120.66},
    // South tip
    {22.22, 120.68}, {22.15, 120.72}, {22.10, 120.75},
    // Southwest coast
    {22.18, 120.68}, {22.28, 120.58}, {22.38, 120.48}, {22.48, 120.40},
    {22.58, 120.34}, {22.68, 120.30}, {22.78, 120.26}, {22.88, 120.23},
    // West coast (detailed)
    {22.98, 120.20}, {23.08, 120.18}, {23.18, 120.17}, {23.28, 120.16},
    {23.38, 120.15}, {23.48, 120.14}, {23.58, 120.13}, {23.68, 120.13},
    {23.78, 120.14}, {23.88, 120.16}, {23.98, 120.19}, {24.08, 120.23},
    // Northwest
    {24.18, 120.28}, {24.28, 120.35}, {24.38, 120.43}, {24.48, 120.52},
    {24.58, 120.62}, {24.68, 120.72}, {24.78, 120.83}, {24.88, 120.95},
    {24.98, 121.08}, {25.08, 121.22}, {25.18, 121.38}, {25.25, 121.48},
    {25.30, 121.57}
  };
