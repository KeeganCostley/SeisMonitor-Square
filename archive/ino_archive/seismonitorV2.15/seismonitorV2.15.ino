...
void drawMap() {
  Serial.print("drawMap() called for region: ");
  Serial.println(config.region);
  
  // TEST: Draw border around entire map area
  tft.drawRect(MAP_X, MAP_Y, MAP_WIDTH, MAP_HEIGHT, TFT_RED);
  tft.drawRect(MAP_X+1, MAP_Y+1, MAP_WIDTH-2, MAP_HEIGHT-2, TFT_RED);
  
  if (strcmp(config.region, "NZ") == 0) {
    Serial.println("Calling drawNZMap()");
    drawNZMap();
  }
  else if (strcmp(config.region, "Japan") == 0) {
    Serial.println("Calling drawJapanMap()");
    drawJapanMap();
  }
  else if (strcmp(config.region, "China") == 0) {
    Serial.println("Calling drawChinaMap()");
    drawChinaMap();
  }
  else if (strcmp(config.region, "California") == 0) {
    Serial.println("Calling drawCaliforniaMap()");
    drawCaliforniaMap();
  }
  else {
    Serial.println("Calling drawGlobalMap()");
    drawGlobalMap();
  }
...
void drawJapanMap() {
  Serial.println("=== DRAWING JAPAN MAP ===");
  
  // HOKKAIDO - More detailed
  const float hokkaido[][2] = {
    {45.5, 141.4}, {45.4, 141.9}, {45.3, 142.4}, {45.1, 142.9},
    {44.9, 143.4}, {44.6, 143.9}, {44.2, 144.4}, {43.8, 144.8},
    {43.3, 145.2}, {42.8, 145.4}, {42.3, 145.3}, {41.9, 144.9},
    {41.6, 144.4}, {41.5, 143.8}, {41.4, 143.2}, {41.4, 142.6},
    {41.4, 142.0}, {41.5, 141.4}, {41.6, 140.8}, {41.8, 140.3},
    {42.1, 140.0}, {42.5, 139.9}, {42.9, 140.0}, {43.3, 140.2},
    {43.7, 140.5}, {44.1, 140.7}, {44.5, 140.9}, {44.9, 141.1},
    {45.2, 141.2}, {45.4, 141.3}, {45.5, 141.4}
  };
  
  // HONSHU - ULTRA DETAILED like NZ (80+ points!)
  const float honshu[][2] = {
    // AOMORI (north tip)
    {41.5, 140.7}, {41.4, 140.8}, {41.3, 140.9}, {41.2, 141.0},
    {41.1, 141.1}, {41.0, 141.2},
    // TOHOKU (northeast coast) - detailed
    {40.8, 141.3}, {40.6, 141.4}, {40.4, 141.5}, {40.2, 141.6},
    {40.0, 141.6}, {39.8, 141.7}, {39.6, 141.7}, {39.4, 141.7},
    {39.2, 141.7}, {39.0, 141.7}, {38.8, 141.6}, {38.6, 141.5},
    {38.4, 141.4}, {38.2, 141.3}, {38.0, 141.1}, {37.8, 140.9},
    {37.6, 140.7}, {37.4, 140.5}, {37.2, 140.3}, {37.0, 140.1},
    // KANTO (Tokyo area) - detailed bulge
    {36.8, 139.9}, {36.6, 139.7}, {36.4, 139.6}, {36.2, 139.6},
    {36.0, 139.7}, {35.8, 139.8}, {35.7, 140.0}, {35.6, 140.2},
    {35.5, 140.4}, {35.5, 140.6}, {35.4, 140.7}, // Boso Peninsula tip
    {35.3, 140.6}, {35.2, 140.5}, {35.1, 140.3}, {35.0, 140.1},
    {34.9, 139.9}, {34.8, 139.7}, {34.7, 139.5}, {34.6, 139.3},
    // IZU Peninsula
    {34.5, 139.1}, {34.4, 138.9}, {34.3, 138.7}, {34.3, 138.5},
    // TOKAI (Suruga Bay)
    {34.4, 138.3}, {34.4, 138.1}, {34.4, 137.9}, {34.3, 137.7},
    {34.3, 137.5}, {34.2, 137.3}, {34.1, 137.1}, {34.0, 136.9},
    // KII Peninsula (southward bulge then indent)
    {34.0, 136.7}, {33.9, 136.5}, {33.8, 136.3}, {33.7, 136.0},
    {33.6, 135.7}, {33.6, 135.4}, {33.7, 135.1}, {33.8, 134.9},
    // OSAKA area
    {33.9, 134.7}, {34.0, 134.5}, {34.1, 134.3}, {34.1, 134.1},
    // SETO INLAND SEA
    {34.1, 133.9}, {34.1, 133.7}, {34.0, 133.5}, {34.0, 133.3},
    {33.9, 133.1}, {33.9, 132.9}, {33.8, 132.7}, {33.8, 132.5},
    // SOUTHWEST (Yamaguchi)
    {33.7, 132.3}, {33.7, 132.1}, {33.6, 131.9}, {33.6, 131.7},
    {33.5, 131.5}, {33.5, 131.3}, {33.5, 131.1},
    // WEST COAST (Sea of Japan) - back up northeast
    {33.6, 131.3}, {33.7, 131.5}, {33.9, 131.7}, {34.1, 131.9},
    {34.3, 132.1}, {34.5, 132.3}, {34.7, 132.5}, {34.9, 132.7},
    {35.1, 132.9}, {35.3, 133.1}, {35.5, 133.3}, {35.7, 133.5},
    {35.9, 133.7}, {36.1, 133.9}, {36.3, 134.1}, {36.5, 134.3},
    {36.7, 134.5}, {36.9, 134.7}, {37.1, 134.9}, {37.3, 135.1},
    {37.5, 135.4}, {37.7, 135.7}, {37.9, 136.0}, {38.1, 136.3},
    {38.3, 136.7}, {38.5, 137.1}, {38.7, 137.5}, {38.9, 137.9},
    {39.1, 138.3}, {39.3, 138.7}, {39.5, 139.1}, {39.7, 139.5},
    {39.9, 139.9}, {40.1, 140.2}, {40.3, 140.4}, {40.5, 140.5},
    {40.7, 140.6}, {40.9, 140.7}, {41.1, 140.7}, {41.3, 140.7},
    {41.5, 140.7}
  };
  
  // KYUSHU
  const float kyushu[][2] = {
    {34.0, 131.0}, {33.8, 131.2}, {33.6, 131.4}, {33.4, 131.5},
    {33.2, 131.6}, {33.0, 131.6}, {32.8, 131.5}, {32.6, 131.3},
    {32.4, 131.1}, {32.3, 130.8}, {32.2, 130.5}, {32.2, 130.2},
    {32.3, 129.9}, {32.5, 129.8}, {32.7, 129.8}, {32.9, 129.8},
    {33.1, 129.9}, {33.3, 130.0}, {33.5, 130.2}, {33.7, 130.4},
    {33.8, 130.6}, {33.9, 130.8}, {34.0, 131.0}
  };
  
  // SHIKOKU  
  const float shikoku[][2] = {
    {34.2, 134.5}, {34.1, 134.7}, {33.9, 134.8}, {33.7, 134.8},
    {33.5, 134.7}, {33.3, 134.5}, {33.2, 134.3}, {33.1, 134.0},
    {33.0, 133.7}, {33.0, 133.4}, {33.1, 133.1}, {33.2, 132.9},
    {33.4, 132.7}, {33.6, 132.6}, {33.8, 132.6}, {34.0, 132.7},
    {34.2, 132.9}, {34.3, 133.1}, {34.4, 133.4}, {34.4, 133.7},
    {34.3, 134.0}, {34.2, 134.3}, {34.2, 134.5}
  };
  ...
  Serial.print("Hokkaido points: ");
  Serial.println(hokkaidoPoints);
  Serial.print("Honshu points: ");
  Serial.println(honshuPoints);
  
  // Draw all islands in BRIGHT COLORS
  for (int i = 0; i < hokkaidoPoints - 1; i++) {
    ...
    tft.drawLine(x1+1, y1, x2+1, y2, TFT_CYAN);
  }
  ...
  Serial.println("Japan map drawn");
  
  // Cities - BIG RED DOTS
  tft.fillCircle(mapLonToScreen(139.69), mapLatToScreen(35.68), 3, TFT_RED); // Tokyo
  tft.fillCircle(mapLonToScreen(135.50), mapLatToScreen(34.69), 3, TFT_RED); // Osaka
  tft.fillCircle(mapLonToScreen(130.42), mapLatToScreen(33.59), 3, TFT_RED); // Fukuoka
}
...
void drawChinaMap() {
  Serial.println("=== DRAWING CHINA MAP ===");
  
  // CHINA - ULTRA DETAILED mainland (150+ points!)
  const float china[][2] = {
    // NORTHEAST CORNER (Heilongjiang - Russian border)
    {53.5, 127.0}, {53.0, 128.0}, {52.5, 129.0}, {52.0, 130.0},
    {51.5, 131.0}, {51.0, 132.0}, {50.5, 133.0}, {50.0, 133.5},
    {49.5, 134.0}, {49.0, 134.2}, {48.5, 134.3},
    
    // NORTHEAST COAST (down toward Korea)
    {48.0, 134.0}, {47.5, 133.5}, {47.0, 133.0}, {46.5, 132.5},
    {46.0, 132.0}, {45.5, 131.5}, {45.0, 131.0}, {44.5, 130.0},
    {44.0, 129.0}, {43.5, 128.0}, {43.0, 127.0}, {42.5, 126.0},
    {42.0, 125.0}, {41.5, 124.0}, {41.0, 123.5},
    
    // BOHAI SEA (big indent - Beijing area)
    {40.5, 122.5}, {40.0, 121.5}, {39.5, 121.0}, {39.0, 120.5},
    {38.5, 120.0}, {38.0, 119.8}, {37.5, 120.0},
    
    // SHANDONG PENINSULA (eastward bulge)
    {37.2, 120.5}, {37.0, 121.0}, {36.8, 121.5}, {37.0, 122.0},
    {37.2, 122.3}, {37.0, 122.5}, {36.5, 122.0}, {36.0, 121.5},
    {35.5, 121.0}, {35.0, 120.5},
    
    // JIANGSU COAST (Nanjing area)
    {34.5, 120.2}, {34.0, 120.0}, {33.5, 120.2}, {33.0, 120.5},
    {32.5, 121.0}, {32.0, 121.5}, {31.5, 121.8},
    
    // SHANGHAI & YANGTZE DELTA
    {31.2, 122.0}, {31.0, 122.2}, {30.8, 122.0}, {30.5, 121.8},
    {30.0, 121.8}, {29.5, 121.5}, {29.0, 121.3},
    
    // ZHEJIANG COAST
    {28.5, 121.2}, {28.0, 121.0}, {27.5, 120.8}, {27.0, 120.6},
    {26.5, 120.3}, {26.0, 120.0}, {25.5, 119.8},
    
    // FUJIAN COAST (Taiwan Strait)
    {25.0, 119.5}, {24.5, 118.8}, {24.0, 118.3}, {23.5, 117.8},
    {23.0, 117.3}, {22.5, 116.8},
    
    // GUANGDONG COAST (Hong Kong area)
    {22.2, 116.0}, {22.0, 115.2}, {21.8, 114.5}, {21.7, 113.8},
    {21.6, 113.2}, {21.5, 112.5}, {21.4, 111.8}, {21.3, 111.2},
    {21.2, 110.5}, {21.1, 109.8}, {21.0, 109.2},
    
    // GUANGXI (Vietnam border - westward)
    {21.2, 108.5}, {21.5, 108.0}, {21.8, 107.5}, {22.0, 107.0},
    {22.2, 106.5}, {22.5, 106.0}, {22.8, 105.5}, {23.2, 105.0},
    {23.6, 104.5}, {24.0, 104.0},
    
    // YUNNAN (Myanmar border - southwest)
    {24.5, 103.5}, {25.0, 103.0}, {25.5, 102.5}, {26.0, 102.0},
    {26.5, 101.5}, {27.0, 101.0}, {27.5, 100.5}, {28.0, 100.0},
    {28.3, 99.5}, {28.6, 99.0}, {28.9, 98.5}, {29.2, 98.0},
    
    // TIBET (Himalayas - BIG westward curve)
    {29.5, 97.0}, {29.7, 96.0}, {29.8, 95.0}, {29.9, 94.0},
    {30.0, 92.5}, {30.1, 91.0}, {30.2, 89.5}, {30.3, 88.0},
    {30.5, 86.5}, {30.8, 85.0}, {31.2, 83.5}, {31.7, 82.0},
    {32.2, 80.5}, {32.8, 79.0}, {33.5, 77.5}, {34.2, 76.5},
    {35.0, 76.0},
    
    // XINJIANG (far west - northward)
    {36.0, 75.8}, {37.0, 75.5}, {38.0, 75.3}, {39.0, 75.2},
    {40.0, 75.3}, {41.0, 75.8}, {42.0, 76.5}, {42.8, 77.5},
    {43.5, 78.8}, {44.0, 80.2}, {44.5, 81.8}, {45.0, 83.5},
    {45.5, 85.2}, {46.0, 87.0}, {46.5, 88.8}, {47.0, 90.5},
    {47.5, 92.2}, {48.0, 94.0}, {48.3, 95.5}, {48.6, 97.0},
    {48.9, 98.5}, {49.2, 100.0}, {49.5, 101.5},
    
    // INNER MONGOLIA (Mongolia border - eastward)
    {49.7, 103.0}, {49.9, 104.5}, {50.1, 106.0}, {50.3, 107.5},
    {50.5, 109.0}, {50.7, 110.5}, {50.9, 112.0}, {51.1, 113.5},
    {51.3, 115.0}, {51.5, 116.5}, {51.8, 118.0}, {52.1, 119.5},
    {52.4, 121.0}, {52.7, 122.5}, {53.0, 124.0}, {53.2, 125.0},
    {53.4, 126.0}, {53.5, 127.0}
  };
  
  int points = sizeof(china) / sizeof(china[0]);
  
  Serial.print("China points: ");
  Serial.println(points);
  
  // Draw outline in BRIGHT CYAN (thick)
  for (int i = 0; i < points - 1; i++) {
    int x1 = mapLonToScreen(china[i][1]);
    int y1 = mapLatToScreen(china[i][0]);
    int x2 = mapLonToScreen(china[i+1][1]);
    int y2 = mapLatToScreen(china[i+1][0]);
    tft.drawLine(x1, y1, x2, y2, TFT_CYAN);
    tft.drawLine(x1+1, y1, x2+1, y2, TFT_CYAN); // Thicker
  }
  
  Serial.println("China map drawn");
  
  // Major cities - BIG RED DOTS
  tft.fillCircle(mapLonToScreen(116.40), mapLatToScreen(39.90), 3, TFT_RED); // Beijing
  tft.fillCircle(mapLonToScreen(121.47), mapLatToScreen(31.23), 3, TFT_RED); // Shanghai
  tft.fillCircle(mapLonToScreen(113.26), mapLatToScreen(23.13), 3, TFT_RED); // Guangzhou
  tft.fillCircle(mapLonToScreen(104.07), mapLatToScreen(30.67), 3, TFT_RED); // Chengdu
}
...
void drawGlobalMap() {
  Serial.println("=== DRAWING GLOBAL MAP ===");
  ...
  // Latitude lines (curved to show globe curvature)
  // Equator
  ...
  for (int x = -radius + 10; x < radius - 10; x++) {
    int y1 = centerY - tropicOffset;
    int y2 = centerY + tropicOffset;
    tft.drawPixel(centerX + x, y1, currentTheme.seismoGrid);
    tft.drawPixel(centerX + x, y2, currentTheme.seismoGrid);
  }
  
  // Meridians (curved longitude lines)
  for (int offset = -45; offset <= 45; offset += 22) {
    for (int y = centerY - radius + 5; y <= centerY + radius - 5; y += 2) {
      int dy = y - centerY;
      float compression = sqrt(1.0 - (dy * dy) / (float)(radius * radius));
      int x = centerX + offset * compression;
      tft.drawPixel(x, y, currentTheme.seismoGrid);
    }
  }
  
  // DETAILED CONTINENTS (recognizable shapes!)
  
  // NORTH AMERICA (detailed)
  const int northAmerica[][2] = {
    {centerX - 45, centerY - 55}, {centerX - 40, centerY - 50}, // Alaska
    {centerX - 35, centerY - 48}, {centerX - 32, centerY - 45}, // Canada north
    {centerX - 30, centerY - 42}, {centerX - 28, centerY - 38}, // Canada
    {centerX - 27, centerY - 33}, {centerX - 26, centerY - 28}, // US north
    {centerX - 28, centerY - 23}, {centerX - 30, centerY - 18}, // US east
    {centerX - 32, centerY - 13}, {centerX - 33, centerY - 8},  // Florida bulge
    {centerX - 32, centerY - 3}, {centerX - 30, centerY + 2},   // Mexico
    {centerX - 28, centerY + 7}, {centerX - 26, centerY + 12}   // Central America
  };
  for (int i = 0; i < 16; i++) {
    tft.drawLine(northAmerica[i][0], northAmerica[i][1], 
                 northAmerica[i+1][0], northAmerica[i+1][1], TFT_CYAN);
  }
  
  // SOUTH AMERICA (distinctive narrow shape)
  const int southAmerica[][2] = {
    {centerX - 26, centerY + 12}, {centerX - 24, centerY + 17}, // Colombia
    {centerX - 25, centerY + 22}, {centerX - 27, centerY + 27}, // Brazil bulge
    {centerX - 28, centerY + 32}, {centerX - 27, centerY + 37}, // Brazil
    {centerX - 25, centerY + 42}, {centerX - 23, centerY + 47}, // Argentina
    {centerX - 21, centerY + 52}  // Chile tip
  };
  for (int i = 0; i < 8; i++) {
    tft.drawLine(southAmerica[i][0], southAmerica[i][1], 
                 southAmerica[i+1][0], southAmerica[i+1][1], TFT_CYAN);
  }
  
  // EUROPE (small but recognizable)
  const int europe[][2] = {
    {centerX + 5, centerY - 48}, {centerX + 8, centerY - 44},   // Scandinavia
    {centerX + 10, centerY - 40}, {centerX + 12, centerY - 35}, // Eastern Europe
    {centerX + 10, centerY - 30}, {centerX + 8, centerY - 26},  // Med
    {centerX + 6, centerY - 22}   // Southern Europe
  };
  for (int i = 0; i < 6; i++) {
    tft.drawLine(europe[i][0], europe[i][1], 
                 europe[i+1][0], europe[i+1][1], TFT_CYAN);
  }
  
  // AFRICA (distinctive shape)
  const int africa[][2] = {
    {centerX + 6, centerY - 22}, {centerX + 10, centerY - 17},  // North Africa
    {centerX + 14, centerY - 12}, {centerX + 16, centerY - 7},  // Sahara
    {centerX + 17, centerY - 2}, {centerX + 18, centerY + 3},   // West bulge
    {centerX + 17, centerY + 8}, {centerX + 16, centerY + 13},  // Central
    {centerX + 15, centerY + 18}, {centerX + 13, centerY + 23}, // East Africa
    {centerX + 11, centerY + 28}, {centerX + 9, centerY + 33},  // South
    {centerX + 7, centerY + 38}   // Cape
  };
  for (int i = 0; i < 12; i++) {
    tft.drawLine(africa[i][0], africa[i][1], 
                 africa[i+1][0], africa[i+1][1], TFT_CYAN);
  }
  
  // ASIA (large distinctive shape)
  const int asia[][2] = {
    {centerX + 12, centerY - 35}, {centerX + 18, centerY - 38}, // Siberia
    {centerX + 24, centerY - 40}, {centerX + 30, centerY - 42}, // Far East
    {centerX + 36, centerY - 40}, {centerX + 40, centerY - 36}, // Japan area
    {centerX + 42, centerY - 30}, {centerX + 43, centerY - 24}, // China
    {centerX + 42, centerY - 18}, {centerX + 40, centerY - 12}, // Southeast
    {centerX + 38, centerY - 6}, {centerX + 35, centerY - 2},   // Indonesia
    {centerX + 32, centerY + 3}   // Java
  };
  for (int i = 0; i < 12; i++) {
    tft.drawLine(asia[i][0], asia[i][1], 
                 asia[i+1][0], asia[i+1][1], TFT_CYAN);
  }
  
  // AUSTRALIA (distinctive)
  const int australia[][2] = {
    {centerX + 35, centerY + 20}, {centerX + 38, centerY + 23},
    {centerX + 41, centerY + 27}, {centerX + 42, centerY + 32},
    {centerX + 41, centerY + 37}, {centerX + 38, centerY + 40},
    {centerX + 34, centerY + 38}, {centerX + 31, centerY + 35},
    {centerX + 30, centerY + 30}, {centerX + 31, centerY + 25},
    {centerX + 33, centerY + 21}, {centerX + 35, centerY + 20}
  };
  for (int i = 0; i < 11; i++) {
    tft.drawLine(australia[i][0], australia[i][1], 
                 australia[i+1][0], australia[i+1][1], TFT_CYAN);
  }
  
  // PACIFIC RING OF FIRE (red arc showing earthquake zones)
  for (int angle = -60; angle <= 240; angle += 3) {
    float rad = angle * 0.0174533;
    int x = centerX + (radius - 10) * cos(rad);
    int y = centerY + (radius - 10) * sin(rad);
    
    int dist = sqrt((x - centerX) * (x - centerX) + (y - centerY) * (y - centerY));
    if (dist < radius - 3) {
      tft.drawPixel(x, y, TFT_RED);
      tft.drawPixel(x+1, y, TFT_RED); // Thicker
    }
  }
  
  Serial.println("Global map drawn");
}
