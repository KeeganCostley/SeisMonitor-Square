...
void drawJapanMap() {
  // HOKKAIDO - Northern island (simple rounded shape)
  const float hokkaido[][2] = {
    {45.5, 141.5}, {45.0, 143.5}, {44.0, 145.0}, {43.0, 145.5},
    {42.0, 145.0}, {41.5, 143.0}, {41.4, 141.0}, {42.0, 140.0},
    {43.5, 140.5}, {45.0, 141.0}, {45.5, 141.5}
  };
  
  // HONSHU - Main island (CURVED ARC shape - the key to recognizability!)
  const float honshu[][2] = {
    // NORTHERN TIP
    {41.5, 140.8},
    // EAST COAST (Pacific side) - relatively straight going south
    {40.5, 141.0}, {39.0, 141.5}, {38.0, 141.0}, {37.0, 140.0},
    // KANTO REGION (Tokyo area - BIG eastward bulge)
    {36.0, 139.5}, {35.7, 140.0}, {35.5, 140.5}, {35.0, 140.0},
    // SOUTH COAST (heading west)
    {34.5, 138.5}, {34.0, 136.5}, {34.0, 135.0}, {34.0, 133.0},
    // SOUTHWEST TIP
    {34.0, 131.5},
    // WEST COAST (Sea of Japan side) - curves back northeast
    {35.0, 132.5}, {36.0, 133.5}, {37.0, 135.0}, {38.0, 137.5},
    {39.0, 139.5}, {40.0, 140.5}, {41.5, 140.8}
  };
  
  // KYUSHU - Southern island
  const float kyushu[][2] = {
    {34.0, 131.0}, {33.5, 131.5}, {33.0, 131.5}, {32.5, 131.0},
    {32.5, 130.5}, {33.0, 130.0}, {33.5, 130.0}, {34.0, 130.5}, {34.0, 131.0}
  };
  
  // SHIKOKU - Island between Honshu and Kyushu
  const float shikoku[][2] = {
    {34.0, 134.0}, {33.5, 134.5}, {33.0, 134.0}, {33.0, 133.0},
    {33.5, 132.5}, {34.0, 133.0}, {34.0, 134.0}
  };
...
void drawTaiwanMap() {
  // Taiwan - Elongated north-south with proper proportions
  // CRITICAL: Only 1.8° wide (120.1 to 121.9) but 3.1° tall (22.0 to 25.1)
  const float taiwan[][2] = {
    // NORTH (Taipei area)
    {25.1, 121.5},
    // EAST COAST (Mountain side - bulges to 121.8°E)
    {24.5, 121.8},  // Northeast bulge (mountains!)
    {24.0, 121.6},
    {23.5, 121.5},
    {23.0, 121.3},
    // SOUTH TIP
    {22.0, 120.8},
    // WEST COAST (Plains side - straighter, 120.1-120.3°E)
    {22.5, 120.2},
    {23.0, 120.1},
    {23.5, 120.1},
    {24.0, 120.2},
    {24.5, 120.5},
    // NORTHWEST (back to Taipei)
    {25.0, 121.0},
    {25.1, 121.5}
  };
