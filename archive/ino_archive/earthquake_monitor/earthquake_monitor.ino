...
#define SEISMO_Y_END 195     // End above the "Latest Activity" section
...
void drawSeismographScreen() {
  ...
  // Draw static box for Latest Activity section
  tft.drawRect(0, 195, 160, 45, TFT_DARKGREY);
...
void updateLatestActivity() {
  ...
  tft.fillRect(1, 196, 158, 43, TFT_BLACK);
  ...
  if (lastQuake.hasData) {
    ...
    // Show magnitude and location (truncate if too long)
    tft.setCursor(5, 224);
    tft.print("M");
    tft.print(lastQuake.magnitude, 1);
    tft.print(" ");
...
void animateSeismograph() {
  ...
  int maxAmplitude = 85; // Amplitude adjusted for the smaller vertical space
