...
const char* globalAPI = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_day.geojson";  // Changed from 2.5 to 4.5
...
void checkForNewQuakes() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    if (httpCode > 0) {
      ...
      // Buffer sized for API responses
      DynamicJsonDocument doc(24576);  // 24KB - enough for M4.5+ global data
